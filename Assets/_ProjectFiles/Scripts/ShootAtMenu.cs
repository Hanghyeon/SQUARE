...
public class ShootAtMenu : MonoBehaviour {
    ...
    public void shoot()
    {
        ...
        //if (go != null)
        //    //rayOrigin = go.GetComponent<SwitchWeapons>().currentGunObject.Find("/Gun").GetComponent<ArmControllerScript>().Spawnpoints.bulletSpawnPoint;
        //else
        //    print("ERROR~!!! rayOrigin is Null~!!!!");
